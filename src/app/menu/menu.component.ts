...
export class MenuComponent implements OnInit {
  ...
  ,private routerIonfo:ActivatedRoute,public http:Http) {
    this.role=this.roleService.getRole(2);
  ...
  ngOnInit() {
    ...
    console.log(this.role);
    this.storage.getItem('role');*/
    //console.log(this.storage.getItem('role').username);
